# macos-app-launch Specification

## Purpose
Define the installed app-bundle launch behavior for StartWatch so UI launch, daemon readiness, and CLI routing are deterministic.
