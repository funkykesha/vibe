...
- [x] 3.12 Add DAEMON_STOP log on daemon shutdown with uptime and reason
...
- [x] 4.7 Test logs command with various filter combinations

## 5. Testing & Verification

- [x] 5.1 Add unit tests for Logger module (write, read, format)
- [x] 5.2 Add integration test: config load with logging verification
- [x] 5.3 Add integration test: service start with logging verification
- [x] 5.4 Add integration test: logs CLI command with filtering
- [x] 5.5 Manual test: Start daemon, verify events.json created with correct entries
- [x] 5.6 Manual test: Run logs CLI command, verify output accuracy
