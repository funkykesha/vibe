...
- **THEN** LaunchServices is refreshed with `lsregister -kill -r -domain local -domain user`
- **THEN** the new app is registered with `lsregister -f /Applications/WorkGuard.app`
