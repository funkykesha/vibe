# observed-model-catalog Specification

## Purpose
Define deterministic catalog visibility from Eliza catalog data, local serving capability rules, and optional observed-health facts from Monium.
