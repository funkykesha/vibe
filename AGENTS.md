...
**Guidance:** [groovy_agent/AGENTS.md](groovy_agent/AGENTS.md) and [groovy_agent/ARCHITECTURE.md](groovy_agent/ARCHITECTURE.md)
...
**Guidance:** [claude_mobile/AGENTS.md](claude_mobile/AGENTS.md)

This is a monorepo containing three separate applications. Navigate to each subproject and read its individual AGENTS.md for detailed instructions.
...
- **Guidance:** [claude_mobile/work_guard/AGENTS.md](claude_mobile/work_guard/AGENTS.md)
...
- **Guidance:** [claude_mobile/finance-dashboard/AGENTS.md](claude_mobile/finance-dashboard/AGENTS.md)
...
2. **Navigate to that project folder:**
   ...
   cd <project-name>
   ```
3. **Read its AGENTS.md** for architecture, build commands, and conventions specific to that project
